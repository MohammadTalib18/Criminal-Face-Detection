...
//     setTitle("CRIMINAL FACE DETECTION");
// 
////     ImageIcon hotel= new ImageIcon(ClassLoader.getSystemResource("icons/logo.jpeg"));
////     Image icon =hotel.getImage();
////     setIconImage(icon);
//     
// ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/simon.jpg"));
//         Image i2=i1.getImage().getScaledInstance(1300,800, Image.SCALE_DEFAULT);
//         ImageIcon i3= new ImageIcon(i2);
//            JLabel image= new JLabel(i3);
//             image.setBounds(0,20,1300,800);
//                add(image);
//
// 
//    JLabel text =new JLabel("CRIMINAL FACE DETECTION");
